...
export function InstallGitHubAppModal({ isOpen, onClose, onSuccess }: InstallGitHubAppModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div
        className={`relative w-full max-w-[480px] rounded-[24px] border-2 shadow-[0_16px_64px_rgba(0,0,0,0.4)] transition-colors ${
          darkTheme ? 'bg-[#3a3228] border-white/30' : 'bg-[#d4c5b0] border-white/40'
        }`}
      >
        {/* Header */}
        <div
          className={`flex items-center justify-between px-5 py-4 border-b-2 transition-colors ${
        ...
        <div className="p-5 space-y-4">
          ...
          <div>
            <h2
              className={`text-[20px] font-bold mb-1.5 transition-colors ${
            ...
            >
              Install the Grainlify app on your GitHub organizations to manage repositories and sync
              data.
            </p>
          </div>
          ...
          <div>
            <h3
              className={`text-[15px] font-semibold mb-2.5 transition-colors ${
                darkTheme ? 'text-[#e8dfd0]' : 'text-[#2d2820]'
              }`}
            >
              Required permissions
          ...
          <div
            className={`p-3 rounded-[10px] ${
              darkTheme
                ? 'bg-[#c9983a]/10 border border-[#c9983a]/30'
          ...
          >
            ...
            >
              <strong>Why GitHub App installation?</strong> Verifies your organization membership
          ...
          >
            ...
            >
              <strong>You stay in control:</strong> Choose which repositories to connect during
              installation. Update permissions whenever you want.
            </p>
          </div>
